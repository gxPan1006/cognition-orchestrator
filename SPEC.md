...
- `root` (path string or `$VAR`)
  - Default: `<system-temp>/cognition_workspaces`
  - `~` is expanded.
...
- `workspace.root`: path resolved to absolute, default `<system-temp>/cognition_workspaces`
...
- `GET /api/v1/<issue_identifier>`
  ...
  - Suggested response shape:
    ...
    ```json
    {
      ...
      "status": "running",
      "workspace": {
        "path": "/tmp/cognition_workspaces/MT-649"
      },
      "attempts": {
        "restart_count": 1,
