defmodule Cognition.LiveE2ETest do
  ...
  defp run_live_issue_flow!(backend) when backend in [:local, :ssh] do
    ...
    try do
      ...
      write_workflow_file!(workflow_file,
        ...
        codex_thread_sandbox: Map.get(worker_setup, :codex_thread_sandbox, "workspace-write"),
  ...
  defp live_ssh_worker_setup!(run_id) when is_binary(run_id) do
    ...
    remote_workspace_root = Path.join(remote_test_root, "workspaces")
