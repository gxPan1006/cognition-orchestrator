defmodule Cognition.TestSupport do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      alias Cognition.AgentRunner
      alias Cognition.CLI
      alias Cognition.Codex.AppServer
      alias Cognition.Config
      alias Cognition.HttpServer
      alias Cognition.Linear.Client
      alias Cognition.Linear.Issue
      alias Cognition.Orchestrator
      alias Cognition.PromptBuilder
      alias Cognition.StatusDashboard
      alias Cognition.Tracker
      alias Cognition.Workflow
      alias Cognition.WorkflowStore
      alias Cognition.Workspace

      import Cognition.TestSupport,
      ...
      setup do
        ...
        if Process.whereis(Cognition.WorkflowStore), do: Cognition.WorkflowStore.force_reload()
  ...
  def write_workflow_file!(path, overrides \\ []) do
    ...
    if Process.whereis(Cognition.WorkflowStore) do
      try do
        Cognition.WorkflowStore.force_reload()
      catch
        :exit, _reason -> :ok
      end
    end
  ...
  def stop_default_http_server do
    case Enum.find(Supervisor.which_children(Cognition.Supervisor), fn
           {Cognition.HttpServer, _pid, _type, _modules} -> true
           _child -> false
         end) do
      {Cognition.HttpServer, pid, _type, _modules} when is_pid(pid) ->
        :ok = Supervisor.terminate_child(Cognition.Supervisor, Cognition.HttpServer)
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          workspace_root: Path.join(System.tmp_dir!(), "cognition_workspaces"),
          worker_ssh_hosts: [],
          ...
          claude_command: "claude --print --verbose --output-format stream-json --permission-mode bypassPermissions",
    ...
    coding_tool_kind = Keyword.get(config, :coding_tool_kind)
    ...
    sections =
      [
        ...
        "coding_tool:",
        "  kind: #{yaml_value(coding_tool_kind)}",
        "codex:",
