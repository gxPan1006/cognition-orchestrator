defmodule Cognition.LogFile do
  @moduledoc """
  ...
  @handler_id :cognition_disk_log
  @default_log_relative_path "log/cognition.log"
  ...
  @spec configure() :: :ok
  def configure do
    log_file = Application.get_env(:cognition, :log_file, default_log_file())
    max_bytes = Application.get_env(:cognition, :log_file_max_bytes, @default_max_bytes)
    max_files = Application.get_env(:cognition, :log_file_max_files, @default_max_files)
