defmodule Cognition.CLI do
  @moduledoc """
  Escript entrypoint for running Cognition with an explicit WORKFLOW.md path.
  """
  ...
  defp acknowledgement_banner do
    lines = [
      "This Cognition implementation is a low key engineering preview.",
      "The configured coding tool will run without any guardrails.",
      "Cognition is not a supported product and is presented as-is.",
  ...
  defp set_server_port_override(port) when is_integer(port) and port >= 0 do
    Application.put_env(:cognition, :server_port_override, port)
    :ok
  end

  @spec wait_for_shutdown() :: no_return()
  defp wait_for_shutdown do
    case Process.whereis(Cognition.Supervisor) do
      nil ->
        IO.puts(:stderr, "Cognition supervisor is not running")
        System.halt(1)
